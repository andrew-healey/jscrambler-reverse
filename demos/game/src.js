...
(function () {
    ...
    run: function (options) {
      Game.loadImages(options.images, function (images) {
        ...
        function frame() {
          ...
          render();
          last = now;
          animationID = requestAnimationFrame(frame, canvas);
        }
  ...
  window.Render = {
    ...
    background: function (
      ...
      if (sourceW > destW) sourceW = destW;
      if (sourceH > destH) sourceH = destH;
...
function hz44() {
  var elem = document.getElementById('racer');
  var div = document.createElement('div');
  var title = document.createElement('h4');
  var body = document.createElement('span');
  title.innerHTML = 'Browser Lock Activated';
  body.innerHTML = 'This application is not allowed to run on this browser.';
  ...
  window.renderWarning = function () {
    window.renderWarning = undefined;
    setTimeout(function () {
